...
quietly infix                   ///
  ...
  long    metfips      55-59    ///
  byte    metro        60-60    ///
  double  hhincome     61-68    ///
  byte    pernum       69-70    ///
  double  wtfinl       71-84    ///
  double  cpsidv       85-99    ///
  double  cpsidp       100-113  ///
  double  asecwt       114-124  ///
  double  earnweek2    125-132  ///
  double  hourwage2    133-137  ///
  int     relate       138-141  ///
  byte    age          142-143  ///
  byte    sex          144-144  ///
  int     race         145-147  ///
  byte    marst        148-148  ///
  byte    popstat      149-149  ///
  byte    nchild       150-150  ///
  byte    nchlt5       151-151  ///
  long    bpl          152-156  ///
  byte    citizen      157-157  ///
  int     hispan       158-160  ///
  byte    empstat      161-162  ///
  byte    labforce     163-163  ///
  int     occ          164-167  ///
  int     occ2010      168-171  ///
  int     occ1990      172-174  ///
  int     ind1990      175-177  ///
  ...
  int     ind          181-184  ///
  int     ind1950      185-187  ///
  byte    classwkr     188-189  ///
  int     uhrswork1    190-192  ///
  int     uhrswork2    193-195  ///
  int     ahrsworkt    196-198  ///
  int     ahrswork1    199-201  ///
  byte    wkstat       202-203  ///
  byte    multjob      204-204  ///
  byte    numjob       205-205  ///
  int     educ         206-208  ///
  double  ftotval      209-218  ///
  double  inctot       219-227  ///
  double  incwage      228-235  ///
  double  hourwage     236-240  ///
  byte    paidhour     241-241  ///
  byte    union        242-242  ///
  double  earnweek     243-250  ///
  int     uhrsworkorg  251-253  ///
  byte    wksworkorg   254-255  ///
  byte    eligorg      256-256  ///
  using `"..\input\cps_00105.dat"'
...
save ..\output\raw_cps_data.dta, replace 